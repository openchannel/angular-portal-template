...
describe('LoginComponent', () => {
            ...
            TestBed.configureTestingModule({
                ...
                imports: [
                    RouterTestingModule.withRoutes([
                        { path: 'manage-apps', component: MockRoutingComponent },
                        { path: 'google', component: MockRoutingComponent },
    ...
    it('should complete destroy$ when component destroys', () => {
    ...
    it('should navigate to the redirectUrl passed to the method (processLoginResponse())', () => {
        ...
        expect(router.navigate).toBeCalledWith([redirectUrl]);
    });
    ...
    it('should navigate to the "" if the redirectUrl is not specified (processLoginResponse())', () => {
        ...
        (component as any).processLoginResponse(response);
        expect(router.navigate).toBeCalledWith(['manage-apps']);
    });
