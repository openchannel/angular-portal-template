## Release notes - template3-portal-frontend - Version 1.67.0 (5/27/2022)<br>
### Task<br>
AT-1799 - Implement SP initiated flow for SAML<br>
## Release notes - template3-portal-frontend - Version 1.66.7 (5/26/2022)<br>
### Task<br>
...
## Release notes - template3-portal-frontend - Version 1.62.0 (1/27/2022)<br>
### Task<br>
...
## Release notes - template3-portal-frontend - Version 1.38.2 (10/4/2021)<br>
### Bug<br>
AT-1533 - [hotfix] Upgrade to compodoc 1.1.15<br>
## Release notes - template3-portal-frontend - Version 1.38.1 (10/4/2021)<br>
### Bug<br>
AT-1527 - [HOTFIX] 500 error occurring when trying to authenticate using Auth0<br>
## Release notes - template3-portal-frontend - Version 1.38.0 (10/1/2021)<br>
### Task<br>
...
## Release notes - template3-portal-frontend - Version 1.23.0 (8/10/2021)<br>
### Story<br>
